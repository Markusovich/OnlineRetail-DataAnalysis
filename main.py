...
# Pipeline
pipelineClustering = Pipeline([('scalar', StandardScaler()), ('kmeans', KMeans(n_clusters=4))])
# Fitting
data[['Number Of Purchases', 'Days From Last Purchase', 'Days From First Purchase', 'Total Revenue']] = \
